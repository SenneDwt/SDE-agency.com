...
const Home = () => {
  return (
    <div className="bg-gray-900 text-white">
      {/* Hero Section */}
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 flex items-center relative overflow-hidden pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="bg-gray-800/60 backdrop-blur-sm rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-purple-500/20">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="bg-gradient-to-br from-purple-600 to-purple-700 p-4 sm:p-6 rounded-2xl text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10"></div>
                    <Globe className="h-6 sm:h-8 w-6 sm:w-8 mb-3 sm:mb-4 relative z-10" />
                    <h3 className="font-semibold mb-2 relative z-10 text-base sm:text-lg">Slimme Websites</h3>
                    <p className="text-sm opacity-90 relative z-10">Responsief, snel en SEO-geoptimaliseerd</p>
                  </div>
                  <div className="bg-gradient-to-br from-cyan-600 to-cyan-700 p-4 sm:p-6 rounded-2xl text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10"></div>
                    <Bot className="h-6 sm:h-8 w-6 sm:w-8 mb-3 sm:mb-4 relative z-10" />
                    <h3 className="font-semibold mb-2 relative z-10 text-base sm:text-lg">AI Chatbots</h3>
                    <p className="text-sm opacity-90 relative z-10">Intelligente klantenservice</p>
                  </div>
                  <div className="bg-gradient-to-br from-orange-600 to-pink-600 p-4 sm:p-6 rounded-2xl text-white col-span-1 sm:col-span-2 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16"></div>
                    <Sparkles className="h-6 sm:h-8 w-6 sm:w-8 mb-3 sm:mb-4 relative z-10" />
                    <h3 className="font-semibold mb-2 relative z-10 text-base sm:text-lg">AI Integratie</h3>
